...
<div class="main mt10">
		<form onsubmit="return checkForm();" id="wshForm" name="wshForm" action="saveWSH.do?wshId=${wshId}" method="post" >
			...
			<tr>
				<td colspan="4">
					...
					<table class="second-table">
						...
						<c:if test="${wshListSize eq 0}">
							<tr><td colspan="4">没有数据。</td></tr>
						</c:if>					
						<c:if test="${wshListSize != 0}">		
							<c:forEach var="wsd" varStatus="cur" items="${wshList}">
								<tr>
									<td><fmt:formatDate value="${wsd.handleDate}"
